...
class MainWindow:
    ...
    def __init__(self, master):
        ...
        f.propagate(0)
        f.pack()
        self.man = PhotoImage(file="/home/abhiram/Downloads/Quiz Application Using MYSQL/Resources/imag.png")
        imgMan = Label(f, image=self.man, bg="azure")
        imgMan.place(x=0, y=60)

        self.mainTitle = Label(f, text="THE KSAB QUIZZ APPLICATION", fg="red" ,bg="azure", font=("Helvetica", 30, "bold italic")).place(
            x=400, y=200)
...
class Register:
    ...
    def __init__(self, master):
        ...
        self.regNow = PhotoImage(file="/home/abhiram/Downloads/Quiz Application Using MYSQL/Resources/RegisterNow.png")
    ...
    def c_submit(self):
        conn = pymysql.connect(host='localhost', database='world', user='root', password='root')
        cursor = conn.cursor()
        name = self.tname.get()
...
class Quiz:
    def __init__(self, master, u):
        ...
        while len(s1) > 0:
            ...
            answerstemp.append(list(cursor.fetchone()))
        ...
        filestr = "/home/abhiram/Downloads/Quiz Application Using MYSQL/Resources" + str(imgID) + ".png"
